          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center space-y-8">
            ...
            <div className="space-y-6">
              <Button
                ...
                className="w-full max-w-md mx-auto bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white py-6 px-10 text-lg font-bold rounded-2xl shadow-xl transform hover:scale-105 transition-all duration-200 relative overflow-hidden"
              >
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center space-y-8">
            ...
            <div className="space-y-6">
              <Button
                ...
                className="w-full max-w-md mx-auto bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white py-6 px-10 text-lg font-bold rounded-2xl shadow-xl transform hover:scale-105 transition-all duration-200"
              >
            ...
            <Card className="max-w-lg mx-auto bg-gradient-to-br from-white to-purple-50 border-2 border-purple-200 shadow-2xl">
              <CardContent className="p-6">
                <div className="relative mb-6">
                  <div className="w-full relative rounded-xl overflow-hidden shadow-lg bg-gray-100">
                    <Image
                      src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/gerador-cadastros-bonus-rvXQICeb3AohU1HjlYXKM1LgYyq2N2.png"
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-3xl mx-auto px-4">
              {[
                {
                  src: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/whatsapp-testimonial-1-7I2O8rpPgR1su9l3zy6y4lKTpDdBWF.png",
                  alt: "Depoimento WhatsApp 1",
                },
                {
                  src: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/whatsapp-testimonial-2-JsnRjowm42sM26jk6rBzcXXeJQI6LL.png",
                ...
                <motion.div
                  ...
                  className="relative"
                >
                  <div className="relative w-full max-w-xs mx-auto rounded-2xl overflow-hidden shadow-xl border-4 border-white bg-gray-100">
                    <Image
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center space-y-8">
            ...
            <Button
              ...
              className="w-full max-w-md mx-auto bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white py-6 px-10 text-xl font-bold rounded-2xl shadow-xl transform hover:scale-105 transition-all duration-200 relative overflow-hidden"
            >
              <div className="absolute inset-0 bg-white/20 animate-pulse"></div>
              <span className="relative flex items-center justify-center gap-2">
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="space-y-12">
              ...
              <div className="text-center space-y-8">
                ...
                <div className="relative w-full max-w-sm mx-auto">
                  <div className="relative rounded-3xl overflow-hidden shadow-2xl border-4 border-white bg-gray-100">
                    <Image
                      src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/woman-laptop-pink-blazer-FDgmnwHICU75YS4scq67LcH1qAP1TE.png"
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 max-w-2xl mx-auto">
                  <div className="bg-white p-6 rounded-2xl shadow-xl border-4 border-green-200 hover:border-green-300 transition-all">
                    <div className="flex items-center gap-4">
                      <div className="relative w-16 h-16 bg-gray-100 rounded-lg flex items-center justify-center">
                        <Image
                          src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/90-days-guarantee-hZbMLdeTE6lUF2rZ0bdlEPzbgkTZwT.png"
                          alt="Garantia"
                          width={64}
                          height={64}
                  ...
                  <div className="bg-white p-6 rounded-2xl shadow-xl border-4 border-blue-200 hover:border-blue-300 transition-all">
                    <div className="flex items-center gap-4">
                      <div className="relative w-32 h-12 bg-gray-100 rounded-lg flex items-center justify-center">
                        <Image
                          src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/hotmart-logo-9VQKGrnH74zyLu40b5W83slVAdOw5c.png"
                          alt="Hotmart"
                          width={128}
                          height={48}
                          className="w-full h-full object-contain"
            ...
            <div className="bg-white p-8 md:p-12 rounded-3xl shadow-2xl border-4 border-green-400">
              <div className="text-center space-y-8">
                ...
                >
                  <div className="absolute inset-0 bg-white/20 animate-pulse"></div>
                  <span className="relative flex flex-col items-center justify-center gap-2 leading-tight">
                    <div className="flex items-center justify-center gap-3">
                      <Trophy className="w-6 h-6 flex-shrink-0" />
                      <span className="font-black text-center whitespace-nowrap">QUERO MEU SCRIPT</span>
                      <Trophy className="w-6 h-6 flex-shrink-0" />
                    </div>
                    <div className="text-lg font-bold">+ TODOS OS BÔNUS!</div>
                  </span>
                </Button>
